            ...
            switch (state) {
                ...
                case SyntaxState.OPEN_TAG_NAME:
                    if (SyntaxState.isTagChars(c)) {
                        openTag.append(c);
                    } else if (SyntaxState.isSpaceOrLineBreak(c)) {
                ...
                case SyntaxState.TAG_INNER:
                    if (SyntaxState.isSpaceOrLineBreak(c)) {
                ...
                case SyntaxState.EQUAL:
                    ...
                    } else if (!SyntaxState.isSpaceOrLineBreak(c) && c != SyntaxState.GT) {
                ...
                case SyntaxState.ATTR_VALUE_NQ:
                    if (!SyntaxState.isSpaceOrLineBreak(c) && c != SyntaxState.GT) {
                        attrValue.append(c);
                    } else if (SyntaxState.isSpaceOrLineBreak(c)) {
                        state = SyntaxState.TAG_INNER;
                        attributes.put(attrName.toString(), attrValue.toString());
